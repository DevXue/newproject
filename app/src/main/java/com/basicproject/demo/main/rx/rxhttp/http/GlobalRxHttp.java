...
import com.basicproject.demo.main.rx.rxhttp.interceptor.ReceivedCookiesInterceptor;
...
public class GlobalRxHttp {
    ...
    public GlobalRxHttp setHeaders(String headerKey,String headerValue) {
        getGlobalOkHttpBuilder().addInterceptor(new HeaderInterceptor(headerKey,headerValue));
        return this;
    }
    ...
    public GlobalRxHttp setCache() {
        ...
        Cache cache = new Cache(new File(Environment.getExternalStorageDirectory().getPath() + "/AppCache")
                , 1024 * 1024 * 100);
