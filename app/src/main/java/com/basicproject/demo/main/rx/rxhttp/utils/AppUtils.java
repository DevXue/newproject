package com.basicproject.demo.main.rx.rxhttp.utils;
...
public class AppUtils {
    ...
    public static String getAppVersion() {
        ...
        String versionNum;
        try {
            PackageManager pm = RxGo.getContext().getPackageManager();
            pi = pm.getPackageInfo(RxGo.getContext().getPackageName(), PackageManager.GET_CONFIGURATIONS);
    ...
    public static String getUUID() {
        ...
        Context context = RxGo.getContext();
