package com.basicproject.demo.common.popu;
...
public abstract class CommonPopupWindow {
    ...
    public CommonPopupWindow(Activity c, int layoutRes, int w, int h) {
        context=c;
    ...
    //展示popu
    public void showPopu(Activity activity,CommonPopupWindow window, View view) {
        PopupWindow win = window.getPopupWindow();
        win.setAnimationStyle(R.style.animPopu);
